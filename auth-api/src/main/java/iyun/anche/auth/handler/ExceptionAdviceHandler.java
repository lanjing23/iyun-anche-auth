package iyun.anche.auth.handler;


import iyun.anche.auth.exception.ArgumentsFailureException;
import iyun.anche.auth.exception.AuthFailureException;
import iyun.anche.auth.exception.NotAuthException;
import iyun.anche.auth.exception.NotAuthorityException;
import iyun.anche.auth.response.BaseResponse;
import iyun.anche.auth.response.SimpleResponse;
...
import static iyun.anche.auth.response.HttpResponse.baseResponse;
import static iyun.anche.auth.response.HttpResponse.simpleResponse;
